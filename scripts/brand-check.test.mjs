...
// The og skill's docs live in the platform sandbox's `.grok/` and are not part
// of the repo; the prose-contract tests below can only run where they exist.
const NEEDS_SKILL_DOC = existsSync(join(TEMPLATE_ROOT, ".grok/skills/og/SKILL.md"))
  ? false
  : "requires .grok/skills/og/SKILL.md (platform sandbox only)";
